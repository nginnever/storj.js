...
function setupAlias(self) {
  ...
  self.createBucket = self.bucket.createBucket;
  self.deleteBucket = self.bucket.deleteBucket;
  self.getBuckets = self.bucket.getBuckets;
  self.getBucket = self.bucket.getBucket;
  self.uploadData = api.uploadData(self);
  self.getData = api.getData(self);
